...
declare const StartClusterHealthCheckCommand_base: {
    new (input: StartClusterHealthCheckCommandInput): import("@smithy/smithy-client").CommandImpl<StartClusterHealthCheckCommandInput, StartClusterHealthCheckCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: StartClusterHealthCheckCommandInput): import("@smithy/smithy-client").CommandImpl<StartClusterHealthCheckCommandInput, StartClusterHealthCheckCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
