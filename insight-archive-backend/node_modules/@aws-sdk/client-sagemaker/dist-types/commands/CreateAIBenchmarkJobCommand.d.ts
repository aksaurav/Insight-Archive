...
declare const CreateAIBenchmarkJobCommand_base: {
    new (input: CreateAIBenchmarkJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAIBenchmarkJobCommandInput, CreateAIBenchmarkJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateAIBenchmarkJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAIBenchmarkJobCommandInput, CreateAIBenchmarkJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
